    ...
    return(
        ...
        <div className="housing_main">
            ...
            <div className="info_container">       
                ...
                <ul className="tag_container">
                    {houseData.tags.map(tag => {
                        return <li key={tag} className="tag_el">{tag}</li>
                    })}
                </ul>
                </div>
                <div className="right_info">
                <div className="host">
                <h3 className="host_name">{houseData.host.name}</h3>
                <div><img src={houseData.host.picture} alt="host profile" className="host_picture"/></div>
                </div>
                <div>
         ...
         <div className="accordeon_container">
             ...
             <div className="accordeon">
             <Dropdown title="Équipements" textecontent={houseData.equipments.map(e => {
                 return <li key={e} className="equipement_el" >{e}</li>
             })} /> 
